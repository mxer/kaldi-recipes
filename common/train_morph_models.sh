...
if [ $# != 1 ]; then
   echo "usage: train_word_models.sh segmentation_dir"
   exit 1;
fi
...
job morfessor_segment 4 48 train_morfessor -- common/morfessor_segment.sh data-prep/text/text.orig.xz data/segmentation/morph1/morfessor.bin data/segmentation/morph1/corpus.xz
...
for d in "0.05" "0.02" "0.01" "0.005" "0.002" "0.001"; do
    ...
    for order in "3" "5" "30"; do
        ...
        job vari_${d}_${order}g 60 48 morfessor_segment -- common/train_varikn_model.sh data/segmentation/morph1/corpus.xz data/segmentation/morph1/vocab ${d} ${order} data/lm/morph1/vk/${d}_${order}g/arpa.xz
