...
for d in "0.1" "0.01" "0.001" "0.00001"; do
    ...
    for order in "3" "8" "12"; do
        ...
        job vari_${d}_${order}g 100 36 morfessor_segment -- common/train_varikn_model.sh data/segmentation/morph1/corpus.xz data/segmentation/morph1/vocab ${d} ${order} data/lm/morph1/vk/${d}_${order}g/arpa.xz

        job recog_lang_${d}_${order}g 40 1 vari_${d}_${order}g,make_morph_lang -- common/make_recog_lang.sh data/lm/morph1/vk/${d}_${order}g/arpa.xz data/langs/morph1_base data/recog_langs/morph1_base_v_${d}_${order}gram
        job recog_lang_${d}_${order}g2 40 1 vari_${d}_${order}g,make_morph_lang -- common/make_recog_lang.sh --inwordbackoff true data/lm/morph1/vk/${d}_${order}g/arpa.xz data/langs/morph1_base data/recog_langs/morph1_base_backoff_v_${d}_${order}gram
        
        job recog_lang_${d}_${order}g_fix1 40 1 vari_${d}_${order}g,make_morph_lang_fix1 -- common/make_recog_lang.sh data/lm/morph1/vk/${d}_${order}g/arpa.xz data/langs/morph1_fix1 data/recog_langs/morph1_fix1_v_${d}_${order}gram
        job recog_lang_${d}_${order}g2_fix1 40 1 vari_${d}_${order}g,make_morph_lang_fix1 -- common/make_recog_lang.sh --inwordbackoff true data/lm/morph1/vk/${d}_${order}g/arpa.xz data/langs/morph1_fix1 data/recog_langs/morph1_fix1_backoff_v_${d}_${order}gram
    done
done
