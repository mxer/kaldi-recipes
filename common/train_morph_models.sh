...
job make_morph_lang 4 4 train_morfessor -- utils/prepare_lang.sh --phone-symbol-table data/lang_train/phones.txt data/dicts/morph1 "<UNK>" data/langs/morph1_base/local data/langs/morph1_base
