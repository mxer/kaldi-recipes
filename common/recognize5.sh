...
srun -n1 steps/nnet3/decode.sh --beam 20.0 --lattice-beam 12.0 --skip-scoring $skip_scoring --nj 5 $decode_flags --scoring-opts "--min-lmwt 1" --online-ivector-dir ${am}/ivecs/ivectors_$(basename ${dataset})_hires ${am}/graph_${sname} ${dataset}_hires ${am}/decode${dsextra}_${sname}
if [ $# -ge 3 ]; then
