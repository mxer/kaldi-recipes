...
model=morph_sami_v7_$(echo $lm | grep -o "N*W[0-9].*/N[0-9a-zA-Z\.]*" | sed "s#/#_#")
...
common/make_dict_est_morph7.sh data/lm/$model/vocab data/lm/$model/word_map data/dicts/$model
