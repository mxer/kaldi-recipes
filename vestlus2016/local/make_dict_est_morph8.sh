...
LC_ALL=en_US.UTF-8 local/make_est_lex_m2m_stage1.py $wordmap data/m2m/lexicon.news.m-mAlign.2-2.1-best.conYX.align > ${tmpdir}/m2m.lex
for i in $(seq 1 10); do
LC_ALL=en_US.UTF-8 local/make_est_lex_m2m_stage2.py $tmpdir/m2m.lex $wordmap lextest4/lexicon.txt >> ${tmpdir}/m2m.lex
