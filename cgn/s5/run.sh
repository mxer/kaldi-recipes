...
for set in "train" "dev" "test"; do
 job mfcc_${set} 4 4 data_prep -- steps/make_mfcc.sh --cmd "${train_cmd}" --nj 20 \
...
job tr_mono0a 40 4 prep_lang,val_dat_train -- steps/train_mono.sh --boost-silence 1.25 --nj 10 --cmd "$train_cmd" data/train data/lang exp/mono0a || error_exit "Train mono failed";
job ali_mono0a 40 4 LAST -- steps/align_si.sh --boost-silence 1.25 --nj 10 --cmd "$train_cmd" data/train data/lang exp/mono0a exp/mono0a_ali || error_exit "Align mono failed";
...
job ali_tri1 40 4 LAST -- steps/align_si.sh --nj 10 --cmd "$train_cmd" data/train data/lang exp/tri1 exp/tri1_ali || error_exit "Align tri failed";
...
job ali_tri2b 40 4 tr_tri2b -- steps/align_si.sh  --nj 10 --cmd "$train_cmd" --use-graphs true data/train data/lang exp/tri2b exp/tri2b_ali || "Align tri2b failed";
